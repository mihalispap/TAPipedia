...
(function ($) {
  ...
  function insertLink(data, editor) {
    ...
    /*
     * patch @ 20150505
     * flag to enable biblio automatically numbered reference 
     */
    var bAutoNumReference = true;
    ...
    if(bAutoNumReference){
      var range = selection.getRanges(1)[0];
      range.deleteContents();
      var aPath = data.path.split("/");
      var content = "[bib]"+aPath[aPath.length-1]+"[/bib]";
