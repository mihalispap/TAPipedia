...
<div id="rsinfo">
	...
	<?php if(isset($content['field_publisher'])){?><div id="ritem"><?php print render($content['field_publisher']);?></div><?php }?>
	...
	<?php if(isset($url)){?>
		<div id="rlresource">
			<a style="color:#fff;" href="<?php echo $url;?>" target="_blank">Download Resource (<?php echo formatBytes(strlen(file_get_contents($url)));?>)
