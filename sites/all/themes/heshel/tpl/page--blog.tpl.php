...
<div class="breadcrumbs type2">
	<div class="container"><?php print  htmlspecialchars_decode($breadcrumb); ?></div>
</div>
<?php endif; ?>
		...
		<div class="content_block row no-sidebar">
			...
			<div class="fl-container">
				<div class="row">
					...
					<div class="posts-block hasLS">
						<div class="contentarea"><?php print render($page['section_content']); ?></div>
					</div>
					<?php endif; ?>
					<?php  if($page['sidebar']):?>
					<div class="left-sidebar-block"><?php print render($page['sidebar']); ?></div>
					<?php endif; ?>
				</div>
			</div>
			<?php  } elseif($sidebar == 'rs') { ?>
			...
			<?php  if($page['sidebar']):?>
			<div class="right-sidebar-block"><?php print render($page['sidebar']); ?></div>
			<?php endif; ?>
			<?php  } else { ?>
			<div class="fl-container">
				<div class="posts-block">
